...
import { verifyCategoryExists, verifyUniqueCategoryName } from "../middlewares/category.middleware"
...
categoryRouter.post('/',verifyToken,verifyAdmin,verifyUniqueCategoryName,createCategoryController)
